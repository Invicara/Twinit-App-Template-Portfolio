...
export default function InfoInteractiveClosableCard({title, subheader, mediaComponent, contentComponent, expandedContentComponent, onClose, disableCardHeader, onCancel, onConfirm}) {
