...
export const ChooseFiles = ({ onAddFiles, busy, busyMsg='Uploading Files' }) => {
   ...
   const handleFileDrop = event => {
    ...
    return <div className="dropzone-anchor">
      {!busy && <div className={clsx("dropzone", dragging && "dragging")} 
      ...
      >
         ...
         <a href="#" onClick={(e) => handleBrowse(e)}>or browse for files</a>
         <input ref={fileInput} onChange={handleFileSelect} type="file" hidden multiple/>
      </div>}
      {busy && <div className="dropzone">
         <div className="icon-wrapper">
