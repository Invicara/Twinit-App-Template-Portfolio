...
export const themeOptions = createTheme({
    ...
    overrides: {
        ...
        MuiButton: {
            ...
            //         border: `1px solid ${colorPalette.secondary.darker}`,
            //     },
            //     borderRadius: '40px'
        ...
        MuiIconButton: {
            ...
            /*
            text: {
                color: colorPalette.secondary.darker
            },
             */
        ...
        //https://v4.mui.com/api/input-base/#css
        ...
        //https://v4.mui.com/api/outlined-input/#css
...
export const darkTheme = createTheme({
    ...
    overrides: {
        ...
        MuiButton: {
            ...themeOptions.overrides.MuiButton,
            outlined: {
...
export const SIDE_DRAWER_STYLE = {
    ...
    containerHeightRight: `calc(100vh - 50px - 40px)`,//this appears to render under the breadcrumbs that are 40px
    tabHeight:'48px',
