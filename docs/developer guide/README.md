# Developer Guide: Portfolio Twinit Application Template
...
* Deploying the Portfolio Template for your users
...
## New Deployments of the Portfolio Twinit Application Template

If you have not yet deployed the Portfolio template, proceed with the steps in this section. If you have a previously deployed instance of the Portfolio template, skip to the **Updating Existing Portfolio Templates** section below.
...
To deploy the Portfolio Twinit Application Template to Twinit and to deploy the web client, follow these steps in order:
...
## Updating an Existing Portfolio Template to 2.0.0

If you have already deployed an earlier version of the Portfolio and wish to update your deployment to the the current version, please refer to the [Developer Update Guide](./update/README.md)
...
* [In-Depth: Portfolio Manager](./implementation/imp-projmake.md)
* [In-Depth: Portfolio Projects](./implementation/imp-qmvprojects.md)
...
Future updates to the Portfolio could include:
