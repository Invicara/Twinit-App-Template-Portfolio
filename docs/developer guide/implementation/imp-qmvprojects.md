...
The User Groups page for managing users access to the Project Maker (via the header menu). This page is provided by ipa-core. Read mroe about this pageComponent and how to confirgur it on [twinit.dev](https://twinit.dev/docs/uiframework/userconfigs/pagehandlers/usergroup).
