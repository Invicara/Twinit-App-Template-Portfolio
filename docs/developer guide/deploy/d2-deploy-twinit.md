...
5. Create an Admin user group for your "Quick Model View Project Maker" project
6. Assign the Project Maker user config to the new Admin user group
...
## Create a New "Quick Model View Project Maker" project

1. Right click on your application name in the Twinit extension and select "New Project"
2. Enter "QMV Project Maker" when prompted for a project name
3. Enter "QMV Project Maker" when prompted for a project description
4. Enter "qmvmaker" when prompted for a project short name
...
7. When prompted for a Config Info file, navigate to the directory in which you have saved the template code, and select ```setup/1.3.0/configInfo.json```
8. When prompted to select config files, navigate to the directory in which you have saved the template code, and select all the ```.json``` files in ```setup/1.3.0/configs```
...
1. Right click on your "QMV Project Maker" project in the extension panel and select "Create a Project Admin Group"

You'll see a notice in the bottom right corner of the VS Cod window once the new Admin user group has been created.

![admin group notice](../../img/vscode-admin-created.jpg)

## Assign the Project Maker User Config
