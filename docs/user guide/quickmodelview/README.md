# Learn How to Use the Portfolio Application

![qmv image](../../img/model-view-docs.jpg)

## Features

The Portfolio Application provides capabilities to upload, import, and view model data on Twinit. Features include:
...
* **Importing of uploaded model representations**. The Portfolio Application provides a Model Import page that allows the user to view the different model representations (bimpks) uploaded to the project and the different file version of those bimpks. The user can then select one at a time to be imported to the project.
* **Viewing the graphics for imported models**. The Portfolio Application provides a Model View page that provides for viewing any version of the imported models in the project. Both 2D and 3D views of the model are supported. All the viewer features are also supported such as cutting planes, and view modes.
...
* **Invite users to view models**. Using the Portfolio Application User Groups page, users can be invited to participate and view models.

## User Groups

Feature access is controlled by the User Group to which a user is a member. There are two user groups in Portfolio projects:

* Admin
* Viewers

Users in the **Admin** user group have full permissions to all resources in the Portfolio project.

Users in the **Viewers** group have read-only permissions to all resources in the Portfolio project.
...
* [How to invite users to a Portfolio project](./inviteusers.md)
