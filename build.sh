...
PRODUCTION_CONFIG='const endPointConfig={itemServiceOrigin:"https://api.invicara.com",passportServiceOrigin:"https://api.invicara.com",fileServiceOrigin:"https://api.invicara.com",datasourceServiceOrigin:"https://api.invicara.com",baseRoot:`${window.location.protocol}//${window.location.host}${window.location.pathname}`,applicationId:"859f8b75-0114-4f70-9edf-8fa8b8e640e5"};'
SANDBOX_CONFIG='const endPointConfig={itemServiceOrigin:"https://sandbox-api.invicara.com",passportServiceOrigin:"https://sandbox-api.invicara.com",fileServiceOrigin:"https://sandbox-api.invicara.com",datasourceServiceOrigin:"https://sandbox-api.invicara.com",baseRoot:`${window.location.protocol}//${window.location.host}${window.location.pathname}`,applicationId:"859f8b75-0114-4f70-9edf-8fa8b8e640e5"};'
