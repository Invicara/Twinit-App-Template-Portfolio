...
PRODUCTION_CONFIG='const endPointConfig={applicationId:"698c1b53-5343-4028-a259-f8d66399c36c", graphicsServiceOrigin:"https://api.invicara.com",itemServiceOrigin:"https://api.invicara.com",passportServiceOrigin:"https://api.invicara.com",fileServiceOrigin:"https://api.invicara.com",datasourceServiceOrigin:"https://api.invicara.com",baseRoot:`${window.location.protocol}//${window.location.host}${window.location.pathname}`};'
...
LOCAL_CONFIG='const endPointConfig={applicationId:"698c1b53-5343-4028-a259-f8d66399c36c", graphicsServiceOrigin:"https://sandbox-api.invicara.com",itemServiceOrigin:"https://sandbox-api.invicara.com",passportServiceOrigin:"https://sandbox-api.invicara.com",fileServiceOrigin:"https://sandbox-api.invicara.com",datasourceServiceOrigin:"https://sandbox-api.invicara.com",baseRoot: "http://lcoalhost:8084/"};'
